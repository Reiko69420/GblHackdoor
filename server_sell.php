...
<?php
        ...
        <div class="container-fluid">
          ...
          <div class="card-body">
                    <center>  ⚠️ INFORMATION ! ⚠️ POUR VENDRE UN SERVEUR GIVE LE SERVEUR A L'ID "666" ! </center>
                    </div>
                    </div>
           <div class="card shadow mb-4">
                ...
                <div class="card-body">
          <table id="server_buy_tbl" cellspacing="0" width="100%" class="table" style="color:black; background-color: white;">
        <thead> 
            <tr>
                ...
                <th style="min-width: 140px!important;">Acheter (35 CC)</th>
              <?php } else { ?>
                <th style="min-width: 140px!important;">Acheter (50 CC)</th>
              <?php } ?>
            </tr>
        </thead>
