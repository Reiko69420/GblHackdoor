                    ...
                    if ($AfficheServer['last_update'] + 30 > time())
    {
                    if($_SESSION['id'] == $AfficheServer['userid']){
                     ...
                     $ip_data = explode(':', $AfficheServer['server_ip']);
                        ...
                        "
                            <tr class='item'>
                                <td><b><img width='16' src='images/" . getgmimage(htmlspecialchars($AfficheServer['gm'])) . "' /></b></td>
...
if($_GET['theget'] == 2){
                    ...
                    if ($AfficheServer['last_update'] + 30 < time())
    {
                    ...
                    if($_SESSION['id'] == $AfficheServer['userid']){
                     ...
                     $button_off_inf = '<a href="seeserver.php?server='.$AfficheServer["id"].'" class="btn btn-primary btn-sm" target="_blank"><i class="fas fa-clone"></i></a>';
...
{    
     $button_dl = '<a onclick="dl(\'http://'.$_SERVER["HTTP_HOST"].'/beta/core/ajax/download-fs.php?ik=45133722&ip='.$data['id'].'\', \''.$data['id'].'.zip\')" href="#" type="button" class="btn btn-success btn-sm"><i class="fas fa-download"></i></a>';
       echo 
                        "
                            <tr class='item'>
