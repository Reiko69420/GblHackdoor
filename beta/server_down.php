<?php include('isdefault.php') ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="breadcome-list"><font color="white">
                                <button onclick="reinfectRCONall()" type="button" class="btn btn-success btn-sm"><i class="fa fa-file-code-o"></i>&nbsp;Reconnecter via RCON touts les serveurs hors-ligne</button>
                                <p>
                    ...
                    if ($AfficheServer['last_update'] + 30 < time())
    {
                    ...
                    $button_off_inf = '<a href="seeserver.php?server='.$AfficheServer["id"].'" class="btn btn-primary btn-sm" ><i class="fas fa-clone"></i></a>';
...
<script>
function reinfectRCONall(id)
{
    $.ajax({
      url: "core/ajax/restart-server.php?f=1"
    }).done(function(data){
        alert("Attendez sur cette pages environs 2 minutes et ensuite dirigé vous sur votre liste de serveur voir si il y a des serveurs qui apparraisse !")
    });
}
...
$('#myInputTextField').keyup(function(){
   ...
   function load_servers() {
     $('#ilyadesserveurs').load('listed_ki_tue.php?theget=2');
   }
</script>
</html>
