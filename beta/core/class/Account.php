...
class Account
{
    ...
    public function SetRank($id, $rank)
    {
        ...
        $GLOBALS['DB']->Update('users', ['id' => $id], ['rank' => $rank]);
    }
    ...
    public function DeleteUser($user_id)
    {
        ...
        Logs::AddLogs("<p class='text-danger'>[".date('d/m/Y à H:i:s', time())."]&nbsp;<i class='fa fa-close'></i>&nbsp;L'utilisateur ".htmlspecialchars($username)." à été supprimé par cette ip :".$ip."</p>");
    }
    ...
    public function ChangePasswordAdmin($id, $password)
    {
        ...
        Logs::AddLogs("<p class='text-primary'>[".date('d/m/Y à H:i:s', time())."]&nbsp;<i class='fa fa-plus'></i>&nbsp;Le Mot de passe de ".htmlspecialchars($user["username"])." à été changer par un administrateur</p>");
    ...
    public function ChangePassword($old_password, $new_password, $confirm_new_password)
    {
        ...
        if (Account::isPasswordTrue($user, $old_password))
        {
               if ($new_password == $confirm_new_password)
               {
                    ...
                    Logs::AddLogs("<p class='text-primary'>[".date('d/m/Y à H:i:s', time())."]&nbsp;<i class='fa fa-plus'></i>&nbsp;Le Mot de passe de ".htmlspecialchars($user["username"])." à été changer par cette ip : ".$ip."</p>");
                    return "success";
               }
               else {
    ...
    public function CreateUser($username, $password, $confirm_password, $grade)
    {
        ...
        Logs::AddLogs("<p class='text-primary'>[".date('d/m/Y à H:i:s', time())."]&nbsp;<i class='fa fa-plus'></i>&nbsp;Le nouvelle utilisateur ".htmlspecialchars($username)." à été créer par cette ip : ".$ip."</p>");
    ...
    public function CreateUserVerif($username, $password, $confirm_password)
    {
        ...
        Logs::AddLogs("<p class='text-primary'>[".date('d/m/Y à H:i:s', time())."]&nbsp;<i class='fa fa-plus'></i>&nbsp;Le nouvelle utilisateur ".htmlspecialchars($username)." à été créer par cette ip : ".$ip." et est en attente de verification</p>");
