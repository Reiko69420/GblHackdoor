...
function IsVIP($id, $addedid = -999)
{
  if($id == $addedid)
    return true;
  if(Account::GetUser($id)["rank"] == "VIP" || Account::GetUser($id)["rank"] == "Administrateur")
    return true;
  return false;
}
...
<div class="container">
  <div class="alert alert-danger alert-dismissible">
    <img src="https://cdn.discordapp.com/attachments/602066929070506022/602168611225731073/599605575365558284.png" style="width:45px;height:45px;"> <strong>Banned !</strong>  Il semblerait que tu soit banni https://discord.gg/mxnpkg9 !
  </div>
